...
public class InsurancemodelController {
	...
	public ModelAndView buyNewInsurance(InsuranceModel im) {
		ModelAndView mvc = new ModelAndView();
		if(imd.getNewInsurance(im).equals("success")) {
			mvc.addObject("data",im);
			mvc.setViewName("proceed.jsp");
		}
		else
		{
	...
	public String makePayment(double insuranceCost) {
		return imd.makePayment(insuranceCost);
	}
